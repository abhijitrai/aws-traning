...
public class DeleteBucket {
    ...
    public static void main(String... args) {
        ...
        String bucketName = "abhijit-test-bucket-1";
        ...
        try {
            ...
            deleteUnVersionedObjects(bucketName, s3Client);
            deleteVersionedObjects(bucketName, s3Client);
    ...
    private static void deleteUnVersionedObjects(String bucketName, AmazonS3 s3Client) {
        ...
        while (true) {
            ...
            while (objIter.hasNext()) {
                ...
                System.out.println("UnVersioned Object deleted : " + objectKey);
            }
    ...
    private static void deleteVersionedObjects(String bucketName, AmazonS3 s3Client) {
